...
<div>
  <!-- chnage this to v-toolbar -->
    ...
    <v-toolbar app  data-app="true" data-booted="true" class="teal lighten-1 toolbar theme--dark" style="margin-top: 0px; padding-right: 0px; padding-left: 0px; transform: translateY(0px);">
      ...
      <v-toolbar-items class="hidden-sm-and-down  v-toolbar__content" style="height: 64px">
        ...
        <router-link to="/Gallery"  class="btn--active btn btn--flat btn--router" style="position: relative;"> <v-btn flat style="color: white">Gallery<i aria-hidden="true" class="icon icon--right theme--dark material-icons">palette</i></v-btn></router-link>
        <router-link to="/Miners"  class="btn--active btn btn--flat btn--router" style="position: relative;"> <v-btn flat style="color: white">Miners<i aria-hidden="true" class="icon icon--right theme--dark material-icons">gavel</i></v-btn></router-link>
