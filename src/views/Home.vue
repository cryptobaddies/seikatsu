<template>
    <body>
        <div data-app="true" class="application theme--light" id="app">
            ...
            <div class="tooltip__content">
                <span
                    >A non-fungible token smart contract secures ownership,
                    authenticity, and transfers. Each painting has a unique
                    token and hash.</span
                >
            </div>
            <div class="tooltip__content">
                <span
                    >Painting owners can order high-quality, signed 36in x 24in
                    prints (additional fee applies).</span
                >
            </div>
            <div class="tooltip__content--two">
                <span
                    >The collection tells the Ethereum blockchain history in a
                    colorful and meaningful way. Each painting represents a
                    given time period.</span
                >
            </div>
            <div class="tooltip__content">
                <span
                    >Each painting is unique, single edition, comes with a
                    high-res 7,680 by 4,320 pixel image, and represents 576
                    consecutive blocks of the Ethereum blockchain.</span
                >
            </div>
            <div class="application--wrap">
                ...
                <nav
                    ...
                    data-booted="true"
                >
                    <div class="toolbar__content" style="height: 56px">
                        <button
                            type="button"
                ...
                <main app="">
                    <span
                                    ...
                                    <div class="jumbotron" style="height: 100%">
                                        <div class="jumbotron__wrapper">
                                            ...
                                            <div class="jumbotron__content">
                                                ...
                                                <div
                                                    class="layout row wrap align-top"
                                                >
                                                    <div
                                                        class="flex xs12 sm12 md3 lg3 pt-2 pb-2 px-2"
                                                    >
                                                        <span
                        ...
                        <div class="layout row mb-3 mt-2">
                                                            ...
                                                            <a
                                                                ...
                                                                >
                                                                    <div
                                                                        ...
                                                                        style="
                                                                            background: url('https://storage.googleapis.com/pcarte/images/00000000-public.png')
                                                                                center
                                                                                center /
                                                                                contain
                                                                                no-repeat;
                                                            ...
                                                            <a
                                                                ...
                                                                >
                                                                    <div
                                                                        class="card__media__background"
                                                                        style="
                                                                            background: url('https://storage.googleapis.com/pcarte/images/00001728-public.png')
                                                                                center
                                                                                center /
                                                                                contain
                                                                                no-repeat;
    ...
    <iframe
        ...
        src="https://checkout.stripe.com/v3/JdhudoUwvSFS85kPDZEQ.html?distinct_id=1bd0204f-cb2d-b561-3605-252741e44394"
